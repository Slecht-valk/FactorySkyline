...
#include "FSBuildableSplitterSmartOperator.h"
...
AFGBuildable* UFSBuildableSplitterSmartOperator::CreateCopy(const FSTransformOperator& TransformOperator)
{
	...
	AFGBuildableSplitterSmart* SourceBuildableSplitterSmart = nullptr;

	if (Source.Buildable) {
		Buildable = BuildableSubsystem->BeginSpawnBuildable(Source.Buildable->GetClass(), Transform);
		SourceBuildableSplitterSmart = Cast<AFGBuildableSplitterSmart>(Source.Buildable);
	}

	AFGBuildableSplitterSmart* BuildableSplitterSmart = Cast<AFGBuildableSplitterSmart>(Buildable);
